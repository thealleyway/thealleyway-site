...
const emailLambdaFunctionEndpoint = '/.netlify/functions/send-email';

const sendStoryEmail = async (name, email, details) => {
  await axios.post(emailLambdaFunctionEndpoint, {
    name,
    email,
    details,
  });
...
export { sendStoryEmail, fieldNames, addToList, truncateString };
