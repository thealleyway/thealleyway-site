...
import { SquiggleWavy, H1StyledContainer, LongLines, LongLinesFlipped, LongLinesContainer, SparkArrowContainer } from './StoryInquiryPage.styles';
...
export default function StoryInquiryPage({
    ...
    return (
        <>
            ...
            <LongLinesContainer>
                <LongLines src={icons.LONG_LINES} alt="long lines with spark at the end" />
                <LongLinesFlipped src={icons.LONG_LINES_FLIPPED} alt="long lines with spark at the end flipped" />
            </LongLinesContainer>
