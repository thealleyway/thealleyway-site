    ...
    return (
        <StoryInquiryFormContainer>
            ...
            <StoryConceptContainer>
                ...
                {isStoryConceptPopup && <MoreAboutPopup popupData={storyConceptPopupData} setIsPopupOpen={setIsStoryConceptPopupOpen} />}
            </StoryConceptContainer>
            <ResourceLinksContainer>
                ...
                <InputFieldWrapper>
                    <TextInputField id="donation page link" label="Donate page link" required />
                </InputFieldWrapper>
                <InputFieldWrapper>
                    <TextInputField id="further education link" label="Further education link" required />
                </InputFieldWrapper>
                <InputFieldWrapper>
                    <TextInputField id="more resources links" label="More resources links" isAdd hasIcon />
                </InputFieldWrapper>
            </ResourceLinksContainer>
            <SquareButtonWrapper>
