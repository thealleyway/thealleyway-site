...
export default function AuthorInfo({ authorInfo }) {
  ...
  return (
    <>
      ...
      <a>
        Signature dimensions: {signature.dimensions.width} x{' '}
        {signature.dimensions.height}{' '}
      </a>
      <br />
      ...
      <a>
        Author image dimensions: {authorImage.dimensions.width} x{' '}
        {authorImage.dimensions.height}{' '}
      </a>
      <br />
      <a>
        Author image alt: {authorImage.alt === null ? 'null' : authorImage.alt}
      </a>
    </>
  );
}
