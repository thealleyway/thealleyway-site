...
const H1Container = styled.div`
  white-space: nowrap;
  font-size: ${(props) =>
    props.longItalicized
      ? `clamp(0.8em, 4.3vw, 1em)`
      : `clamp(0.8em, 4.5vw, 1em)`};
  margin: ${(props) =>
    props.longItalicized ? `6em 0 0em 3em` : `9.5em 0 0 3em`};
  @media ${min.tablet} {
    margin: ${(props) =>
      props.longItalicized ? `8em 0 4em 5em` : `15em 0 4em 5em`};
  }
  @media ${min.desktop} {
